...
class OmniGraffle6Exporter(object):
    ...
    def export_item(self, fname, export_format):
        ...
        if self.sandboxed():
            export_path = os.path.expanduser(self.SANDBOXED_DIR_6) + os.path.basename(fname)
    ...
    def backup_current_export_settings(self):
        ...
        self.settings_backup["area_type"] = self.og.current_export_settings.area_type()
        self.settings_backup["border_amount"] = self.og.current_export_settings.border_amount()
        self.settings_backup["resolution"] = self.og.current_export_settings.resolution()
        self.settings_backup["export_scale"] = self.og.current_export_settings.export_scale()
        self.settings_backup['draws_background'] = self.og.current_export_settings.draws_background()
        #self.settings_backup['html_image_type'] = self.og.current_export_settings.html_image_type()
        self.settings_backup['include_border'] = self.og.current_export_settings.include_border()
        self.settings_backup['origin'] = self.og.current_export_settings.origin()
    ...
    def restore_saved_export_settings(self):
        ...
        self.og.current_export_settings.area_type.set(self.settings_backup['area_type'])
        self.og.current_export_settings.border_amount.set(self.settings_backup['border_amount'])
        self.og.current_export_settings.resolution.set(self.settings_backup['resolution'])
        self.og.current_export_settings.export_scale.set(self.settings_backup['export_scale'])
        self.og.current_export_settings.draws_background.set(self.settings_backup['draws_background'])
        ...
        self.og.current_export_settings.include_border.set(self.settings_backup['include_border'])
        self.og.current_export_settings.origin.set(self.settings_backup['origin'])
    ...
    def set_export_settings(self):
        ...
        if self.args.resolution:
            self.og.current_export_settings.resolution.set(self.args.resolution)
        if self.args.scale:
